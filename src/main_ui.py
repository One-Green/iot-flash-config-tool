...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(10, 370, 451, 51))
        ...
        self.gridLayout_6.addWidget(self.lineEdit_10, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_11, 3, 1, 1, 1)
        ...
        self.gitCloneOrFetchButton_2 = QtWidgets.QPushButton(self.gridLayoutWidget_7)
        self.gitCloneOrFetchButton_2.setObjectName("gitCloneOrFetchButton_2")
        self.gridLayout_7.addWidget(self.gitCloneOrFetchButton_2, 0, 0, 1, 1)
        self.gitCloneOrFetchStatus_2 = QtWidgets.QLabel(self.gridLayoutWidget_7)
        self.gitCloneOrFetchStatus_2.setObjectName("gitCloneOrFetchStatus_2")
        self.gridLayout_7.addWidget(self.gitCloneOrFetchStatus_2, 0, 2, 1, 1)
        self.gitCloneOrFetchStatusLabel_2 = QtWidgets.QLabel(self.gridLayoutWidget_7)
        self.gitCloneOrFetchStatusLabel_2.setObjectName("gitCloneOrFetchStatusLabel_2")
        self.gridLayout_7.addWidget(self.gitCloneOrFetchStatusLabel_2, 0, 1, 1, 1)
        ...
        self.gitCloneOrFetchButton_3 = QtWidgets.QPushButton(self.gridLayoutWidget_8)
        self.gitCloneOrFetchButton_3.setObjectName("gitCloneOrFetchButton_3")
        self.gridLayout_8.addWidget(self.gitCloneOrFetchButton_3, 0, 0, 1, 1)
        self.gitCloneOrFetchStatus_3 = QtWidgets.QLabel(self.gridLayoutWidget_8)
        self.gitCloneOrFetchStatus_3.setObjectName("gitCloneOrFetchStatus_3")
        self.gridLayout_8.addWidget(self.gitCloneOrFetchStatus_3, 0, 2, 1, 1)
        self.gitCloneOrFetchStatusLabel_3 = QtWidgets.QLabel(self.gridLayoutWidget_8)
        self.gitCloneOrFetchStatusLabel_3.setObjectName("gitCloneOrFetchStatusLabel_3")
        self.gridLayout_8.addWidget(self.gitCloneOrFetchStatusLabel_3, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Load config file"))
        self.pushButton_2.setText(_translate("MainWindow", "Save config file"))
        self.label_8.setText(_translate("MainWindow", "Api port"))
        self.label_9.setText(_translate("MainWindow", "Api username"))
        self.label_7.setText(_translate("MainWindow", "Api host"))
        self.label_10.setText(_translate("MainWindow", "Api password"))
        ...
        self.label_18.setText(_translate("MainWindow", "MQTT password"))
        self.gitCloneOrFetchButton_2.setText(_translate("MainWindow", "Test API con."))
        self.gitCloneOrFetchStatus_2.setText(_translate("MainWindow", "unknow"))
        self.gitCloneOrFetchStatusLabel_2.setText(_translate("MainWindow", "status:"))
        self.gitCloneOrFetchButton_3.setText(_translate("MainWindow", "Test MQTT con."))
        self.gitCloneOrFetchStatus_3.setText(_translate("MainWindow", "unknow"))
        self.gitCloneOrFetchStatusLabel_3.setText(_translate("MainWindow", "status:"))
        self.Flash.setTabText(
