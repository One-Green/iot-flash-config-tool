...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gitVersionList = QtWidgets.QListView(self.groupBox_2)
        self.gitVersionList.setGeometry(QtCore.QRect(10, 30, 151, 181))
        self.gitVersionList.setObjectName("gitVersionList")
